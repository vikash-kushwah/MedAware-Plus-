<!DOCTYPE html>
<html>
<body style="background-image:url(images/blur-hospital.jpg)">
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/cal.png" width="30px" height="30px"><strong> MedAware Plus &nbsp</strong> Empower Individuals </a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="http://localhost/bookapp/Awareness.html">Health Awareness</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1>MedAware Plus +</h1><br>
				<p style="text-align:center;color:black;font-size:30px;top:35%" >Online Appointment Booking System</p><br>
				<button onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:45%;left:45%">Login</button>
